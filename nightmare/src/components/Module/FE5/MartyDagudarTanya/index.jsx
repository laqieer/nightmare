...
import {
  FE5MartyDagudarTanyaEntries, FE5CharacterList, FE5ItemData,
} from './options';
...
export default function FE5MartyDagudarTanya() {
  ...
  return (
    ...
    >
      <Alert
        message="Marty, Dagudar, Tanya"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE5MartyDagudarTanyaEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE5MartyDagudarTanyaEntries}
        />
      </div>
      <InputDropbox
        isHex
