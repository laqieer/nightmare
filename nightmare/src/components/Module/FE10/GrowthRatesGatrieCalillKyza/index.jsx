...
export default function FE10GrowthRatesGatrieCalillKyza() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Gatrie,Calill & Kyza"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates8.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates8}
        />
      </div>
      <InputDec
        type={DataType.S8}
