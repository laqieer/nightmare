...
export default function FE10GrowthRatesEdwardElincia() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Edward & Elincia"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates4.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates4}
        />
      </div>
      <InputDec
        type={DataType.S8}
