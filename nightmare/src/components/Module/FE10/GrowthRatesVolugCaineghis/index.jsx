...
export default function FE10GrowthRatesVolugCaineghis() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Volug & Caineghis"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates7.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates7}
        />
      </div>
      <InputDec
        type={DataType.S8}
