...
export default function FE10GrowthRatesTibarnDheginsea() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Tibarn, Dheginsea"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates16.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates16}
        />
      </div>
      <InputDec
        type={DataType.S8}
