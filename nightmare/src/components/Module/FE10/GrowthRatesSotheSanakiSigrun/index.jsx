...
export default function FE10GrowthRatesSotheSanakiSigrun() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Sothe, Sanaki & Sigrun"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates10.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates10}
        />
      </div>
      <InputDec
        type={DataType.S8}
