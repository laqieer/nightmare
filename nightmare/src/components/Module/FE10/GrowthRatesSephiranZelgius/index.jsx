...
export default function FE10GrowthRatesSephiranZelgius() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Sephiran, Zelgius"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates14.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates14}
        />
      </div>
      <InputDec
        type={DataType.S8}
