...
export default function FE10GrowthRatesNealuchiNailahNaesala() {
  ...
  return (
    ...
    >
      <Alert
        message="FE10 Growth Rates-Nealuchi, Nailah, Naesala"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE10GrowthRates18.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE10GrowthRates18}
        />
      </div>
      <InputDec
        type={DataType.S8}
