...
import {
  FE11Chapter20UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter20UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 20 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter20UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter20UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
