...
import {
  FE11Chapter4UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter4UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 4 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter4UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter4UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
