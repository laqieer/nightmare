...
import {
  FE11Chapter20xUnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter20xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 20x Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter20xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter20xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
