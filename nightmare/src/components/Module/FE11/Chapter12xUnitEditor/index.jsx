...
import {
  FE11Chapter12xUnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter12xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 12x Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter12xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter12xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
