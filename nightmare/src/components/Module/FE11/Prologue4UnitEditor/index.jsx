...
import {
  FE11Prologue4UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Prologue4UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Prologue 4 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Prologue4UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Prologue4UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
