...
import {
  FE11Chapter22UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter22UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 22 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter22UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter22UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
