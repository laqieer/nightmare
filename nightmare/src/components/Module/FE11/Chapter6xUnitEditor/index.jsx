...
import {
  FE11Chapter6xUnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter6xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 6x Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter6xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter6xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
