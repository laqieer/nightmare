...
import {
  FE11Chapter10UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter10UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 10 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter10UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter10UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
