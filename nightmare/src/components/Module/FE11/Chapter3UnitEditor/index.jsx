...
import {
  FE11Chapter3UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter3UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 3 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter3UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter3UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
