...
import {
  FE11Chapter23UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter23UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 23 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter23UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter23UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
