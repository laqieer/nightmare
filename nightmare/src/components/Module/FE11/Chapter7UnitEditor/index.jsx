...
import {
  FE11Chapter7UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter7UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 7 Unit Editor by Blazer"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter7UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter7UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
