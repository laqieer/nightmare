...
import {
  FE11Chapter9UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter9UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 9 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter9UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter9UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
