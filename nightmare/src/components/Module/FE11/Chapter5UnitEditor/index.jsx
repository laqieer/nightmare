...
import {
  FE11Chapter5UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter5UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 5 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter5UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter5UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
