...
import {
  FE11Chapter14UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter14UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 14 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter14UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter14UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
