...
import {
  FE11Chapter18UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter18UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 18 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter18UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter18UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
