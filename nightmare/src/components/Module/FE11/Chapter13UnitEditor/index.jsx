...
import {
  FE11Chapter13UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter13UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 13 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter13UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter13UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
