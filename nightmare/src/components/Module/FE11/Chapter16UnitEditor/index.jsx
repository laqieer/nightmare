...
import {
  FE11Chapter16UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter16UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 16 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter16UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter16UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
