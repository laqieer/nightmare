...
import {
  FE11Prologue2UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Prologue2UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Prologue 2 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Prologue2UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Prologue2UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
