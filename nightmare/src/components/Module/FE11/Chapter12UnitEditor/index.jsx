...
import {
  FE11Chapter12UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter12UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 12 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter12UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter12UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
