...
import {
  FE11Chapter24UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter24UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 24 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter24UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter24UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
