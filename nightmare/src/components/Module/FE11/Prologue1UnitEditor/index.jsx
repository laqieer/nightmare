...
import {
  FE11Prologue1UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Prologue1UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Prologue 1 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Prologue1UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Prologue1UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
