...
import {
  FE11Chapter19UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter19UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 19 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter19UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter19UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
