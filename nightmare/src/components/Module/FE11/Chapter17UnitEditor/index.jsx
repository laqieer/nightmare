...
import {
  FE11Chapter17UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter17UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 17 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter17UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter17UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
