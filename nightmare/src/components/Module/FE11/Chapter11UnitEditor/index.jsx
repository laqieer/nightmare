...
import {
  FE11Chapter11UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter11UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 11 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter11UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter11UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
