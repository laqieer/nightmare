...
import {
  FE11Chapter17xUnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Chapter17xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 17x Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Chapter17xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Chapter17xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
