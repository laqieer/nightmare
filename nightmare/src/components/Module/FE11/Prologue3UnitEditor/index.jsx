...
import {
  FE11Prologue3UnitEditorEntries, Characters, Classes, Enemy1,
...
export default function FE11Prologue3UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Prologue 3 Unit Editor by Blazer/Mariode"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE11Prologue3UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE11Prologue3UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
