...
import {
  Ruins1, CharacterList, ClassHexList, StartingLevel,
...
export default function FE8TowerofValni4LagdouRuins1UnitEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0x8CC9B8;
  const size = 20;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Tower of Valni 4 & Lagdou Ruins 1 Unit Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={Ruins1.find(
