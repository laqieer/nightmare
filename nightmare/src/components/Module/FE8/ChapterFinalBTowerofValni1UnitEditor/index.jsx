...
import {
  Valni1, CharacterList, ClassHexList, StartingLevel,
...
export default function FE8ChapterFinalBTowerofValni1UnitEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0x8CB060;
  const size = 20;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Chapter FinalB & Tower of Valni 1 Unit Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={Valni1.find(
