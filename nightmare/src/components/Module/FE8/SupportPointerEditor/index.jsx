...
export default function FE8SupportPointerEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="FE8 Support Pointer Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={SupportPointer2.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={SupportPointer2}
        />
      </div>
      <InputDec
        type={DataType.U8}
