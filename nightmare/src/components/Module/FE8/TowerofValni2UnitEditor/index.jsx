...
import {
  Valni2, CharacterList, ClassHexList, StartingLevel,
...
export default function FE8TowerofValni2UnitEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0x8CB918;
  const size = 20;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Tower of Valni 2 Unit Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={Valni2.find(
