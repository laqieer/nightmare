...
import {
  Ruins2, CharacterList, ClassHexList, StartingLevel,
...
export default function FE8LagdouRuins2MelkaenCoastUnitEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0x8CEC84;
  const size = 20;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Lagdou Ruins 2 & Melkaen Coast Unit Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={Ruins2.find(
