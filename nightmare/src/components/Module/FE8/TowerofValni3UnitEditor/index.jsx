...
import {
  Valni3, CharacterList, ClassHexList, StartingLevel,
...
export default function FE8TowerofValni3UnitEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0x8CBF24;
  const size = 20;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Tower of Valni 3 Unit Editor"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={Valni3.find(
