...
import {
  FE7ItemEditorEntries, ItemList, WeaponType, WeaponAbility1,
  WeaponAbility2, WeaponAbility3, WeaponAbility4, WeaponRank,
  ItemIcons, Staffuseeffect, WeaponEffect,
} from './options';
...
export default function FE7ItemEditor() {
  const [buffer] = useOutletContext();
  const [searchParams, setSearchParams] = useSearchParams();

  const id = searchParams.get('id');
  const address = 0xBE222C;
  const size = 36;
  let view = null;
