...
import {
  Coordinates2, Block, PaletteFlip,
} from './options';
import { DataType } from '../../../util';
import InputSelect from '../../../Input/InputSelect';
import InputDropbox from '../../../Input/InputDropbox';

export default function FE7Battlescreeneditorpart4() {
  const [buffer] = useOutletContext();

  const [index, setIndex] = useState(0);

  const address = 0x1D8E70;
  const size = 32;
  let view = null;
  ...
  return (
    ...
    >
      <Alert
        message="Battle screen editor part 4 by Nintenlord"
        type="info"
      />
      <InputSelect
        disabled={view == null}
      ...
      <InputDropbox
        ...
        options={PaletteFlip}
        view={view}
        name="Palette and Flipping (31,Y)"
        offset={31}
      />
