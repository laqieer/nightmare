...
import {
  FE12Chapter19UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter19UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 19 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter19UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter19UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
