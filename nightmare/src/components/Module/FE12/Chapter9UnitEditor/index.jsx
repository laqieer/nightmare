...
import {
  FE12Chapter9UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter9UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 9 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter9UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter9UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
