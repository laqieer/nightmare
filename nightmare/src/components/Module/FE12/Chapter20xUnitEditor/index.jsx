...
import {
  FE12Chapter20xUnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter20xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 20x Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter20xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter20xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
