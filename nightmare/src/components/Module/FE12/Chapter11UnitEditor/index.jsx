...
import {
  FE12Chapter11UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter11UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 11 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter11UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter11UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
