...
import {
  FE12ChapterBSFE2UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterBSFE2UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter BSFE2 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterBSFE2UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterBSFE2UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
