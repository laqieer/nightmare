...
import {
  FE12Chapter16xUnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter16xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 16x Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter16xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter16xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
