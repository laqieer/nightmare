...
import {
  FE12Chapter10UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter10UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 10 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter10UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter10UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
