...
import {
  FE12Chapter2UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter2UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 2 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter2UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter2UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
