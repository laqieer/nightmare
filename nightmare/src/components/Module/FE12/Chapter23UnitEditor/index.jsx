...
import {
  FE12Chapter23UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter23UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 23 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter23UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter23UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
