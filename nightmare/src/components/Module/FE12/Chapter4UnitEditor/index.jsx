...
import {
  FE12Chapter4UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter4UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 4 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter4UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter4UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
