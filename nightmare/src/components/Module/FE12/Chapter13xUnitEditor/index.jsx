...
import {
  FE12Chapter13xUnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter13xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 13x Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter13xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter13xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
