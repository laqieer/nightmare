...
import {
  FE12ChapterDL2UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterDL2UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter DL2 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterDL2UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterDL2UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
