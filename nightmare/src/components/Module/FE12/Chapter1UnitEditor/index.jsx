...
import {
  FE12Chapter1UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter1UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 1 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter1UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter1UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
