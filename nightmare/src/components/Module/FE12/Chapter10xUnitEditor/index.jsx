...
import {
  FE12Chapter10xUnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter10xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 10x Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter10xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter10xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
