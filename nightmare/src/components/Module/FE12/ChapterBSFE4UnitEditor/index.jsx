...
import {
  FE12ChapterBSFE4UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterBSFE4UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter BSFE4 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterBSFE4UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterBSFE4UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
