...
import {
  FE12Chapter22UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter22UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 22 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter22UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter22UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
