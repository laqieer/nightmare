...
import {
  FE12Chapter24UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter24UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 24 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter24UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter24UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
