...
import {
  FE12Chapter5UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter5UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 5 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter5UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter5UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
