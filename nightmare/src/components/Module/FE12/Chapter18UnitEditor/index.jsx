...
import {
  FE12Chapter18UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter18UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 18 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter18UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter18UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
