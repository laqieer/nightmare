...
import {
  FE12ChapterDL3UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterDL3UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter DL3 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterDL3UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterDL3UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
