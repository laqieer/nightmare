...
import {
  FE12Chapter3UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter3UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 3 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter3UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter3UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
