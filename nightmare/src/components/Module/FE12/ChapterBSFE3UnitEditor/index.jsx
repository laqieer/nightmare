...
import {
  FE12ChapterBSFE3UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterBSFE3UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter BSFE3 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterBSFE3UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterBSFE3UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
