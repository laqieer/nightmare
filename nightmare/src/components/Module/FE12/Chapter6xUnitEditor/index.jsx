...
import {
  FE12Chapter6xUnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter6xUnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 6x Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter6xUnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter6xUnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
