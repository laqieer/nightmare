...
import {
  FE12Chapter8UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter8UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 8 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter8UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter8UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
