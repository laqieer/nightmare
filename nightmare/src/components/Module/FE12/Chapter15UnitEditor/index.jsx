...
import {
  FE12Chapter15UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter15UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 15 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter15UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter15UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
