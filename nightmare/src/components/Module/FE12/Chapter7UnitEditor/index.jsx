...
import {
  FE12Chapter7UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter7UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 7 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter7UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter7UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
