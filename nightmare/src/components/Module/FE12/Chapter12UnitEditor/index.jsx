...
import {
  FE12Chapter12UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter12UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 12 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter12UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter12UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
