...
import {
  FE12Chapter14UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter14UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 14 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter14UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter14UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
