...
import {
  FE12ChapterBSFE1UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12ChapterBSFE1UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter BSFE1 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12ChapterBSFE1UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12ChapterBSFE1UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
