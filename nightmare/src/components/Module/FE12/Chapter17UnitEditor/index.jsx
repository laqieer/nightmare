...
import {
  FE12Chapter17UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter17UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 17 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter17UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter17UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
