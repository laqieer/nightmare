...
import {
  FE12Chapter13UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter13UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 13 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter13UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter13UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
