...
import {
  FE12Chapter20UnitEditorEntries, Charlist, Classlist, Itemlist,
} from './options';
...
export default function FE12Chapter20UnitEditor() {
  ...
  return (
    ...
    >
      <Alert
        message="Chapter 20 Unit Editor by VincentASM"
        type="info"
      />
      <div key={id}>
        <InputSelect
          disabled={view == null}
          defaultValue={FE12Chapter20UnitEditorEntries.find(
            (entry) => entry.value.toString() === id,
          ) ?? id}
          onSelect={(value) => setSearchParams({ id: value })}
          options={FE12Chapter20UnitEditorEntries}
        />
      </div>
      <InputDropbox
        isHex
